        ...
        <div className="container max-w-7xl mx-auto relative z-10">
          ...
          <div className="mx-auto max-w-3xl text-center mb-16">
           ...
           tracking-tight sm:text-5xl md:text-6xl mb-1">
            ...
            >
              <a
                href="https://luma.com/event/evt-SCZzwwXtFfozXew"
                className="luma-checkout--button group flex items-center justify-center gap-2 px-8 py-4 w-fit min-h-[52px] rounded-full border-2 border-white hover:scale-105 hover:shadow-lg hover:shadow-white/50 hover:bg-[#b84303] active:scale-95 transition-all duration-300 text-base font-semibold text-white"
                style={{ backgroundColor: "#d95404" }}
                data-luma-action="checkout"
                data-luma-event-id="evt-SCZzwwXtFfozXew"
                onClick={() =>
                  posthog?.capture("cta_register_here_clicked", {

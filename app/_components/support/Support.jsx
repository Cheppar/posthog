...
const supportDataArray = {
  ...
  supportOptions: [
    ...
    },
    {
      ...
      icon: "CreditCard",
      title: "PayPal",
      description: "Make a secure donation through PayPal. Quick and easy payment processing.",
    ...
    },
    {
      ...
      icon: "Smartphone",
      title: "M-Pesa",
      description: "Support us via M-Pesa through our secure payment page. Quick and easy transactions.",
